<div class="navbar-custom">
    <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <div class="inbox-widget">
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="uplon\assets\images\users\avatar-1.jpg"
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="uplon\assets\images\users\avatar-2.jpg"
                                        class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="uplon\assets\images\users\avatar-3.jpg"
                                        class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="uplon\assets\images\users\avatar-4.jpg"
                                        class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="uplon\assets\images\users\avatar-5.jpg"
                                        class="rounded-circle" alt=""></div>
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown"
                ...
                <img src="{{ asset('uplon\assets\images\users\avatar-1.jpg') }}" alt="user-image"
    ...
    <div class="logo-box">
        <a href="{{ route('admin') }}" class="logo text-center logo-dark">
            <span class="logo-lg">
                <img src="{{ asset('uplon\assets\images\logo.png') }}" alt="" height="22">
                <!-- <span class="logo-lg-text-dark">Uplon</span> -->
            </span>
            <span class="logo-sm">
                <!-- <span class="logo-lg-text-dark">U</span> -->
                <img src="{{ asset('uplon\assets\images\logo-sm.png') }}" alt="" height="24">
            </span>
        </a>

        <a href="index.html" class="logo text-center logo-light">
            <span class="logo-lg">
                <img src="{{ asset('uplon\assets\images\logo-light.png') }}" alt="" height="22">
                <!-- <span class="logo-lg-text-dark">Uplon</span> -->
            </span>
            <span class="logo-sm">
                <!-- <span class="logo-lg-text-dark">U</span> -->
                <img src="{{ asset('uplon\assets\images\logo-sm-light.png') }}" alt="" height="24">
            </span>
        </a>
    </div>
